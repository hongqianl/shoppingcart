...
export function CardSmall({product}) {
  ...
  return (
    ...
    // </div>
 <div className="flex items-center grid grid-cols-4  gap-4 max-w-screen-xl border-2 border-slate-200 rounded-lg p-3 m-1">
    ...
    <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
    <button onClick={onDeleteFromCart} className="bg-red-500 rounded-lg text-white p-2 text-sm ">Remove</button>
    </div>
